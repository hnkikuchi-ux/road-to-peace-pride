...
#rppFaithfulV8 .v8-road{position:absolute;left:19%;top:48.15%;width:62%;height:16.9%;overflow:visible;filter:drop-shadow(0 0 5px rgba(255,203,76,.46));opacity:.98}
#rppFaithfulV8 .v8-road .halo{fill:none;stroke:#ffc94c;stroke-linecap:round;stroke-linejoin:round;opacity:.24;filter:blur(2.6px)}
#rppFaithfulV8 .v8-road .core{fill:none;stroke:url(#v8RoadGold);stroke-linecap:round;stroke-linejoin:round;filter:drop-shadow(0 0 2px rgba(255,234,155,.70))}
#rppFaithfulV8 .v8-road .s1{stroke-width:10}.v8-road .s2{stroke-width:7}.v8-road .s3{stroke-width:4.6}.v8-road .s4{stroke-width:2.8}.v8-road .s5{stroke-width:1.6}
#rppFaithfulV8 .v8-road .halo.s1{stroke-width:18}.v8-road .halo.s2{stroke-width:13}.v8-road .halo.s3{stroke-width:9}.v8-road .halo.s4{stroke-width:6}.v8-road .halo.s5{stroke-width:4}
...
@media(max-width:380px){
  #rppFaithfulV7 .v7-bridge{font-size:13px!important}
...
<script>
(()=>{
 const ROAD='<div id="rppFaithfulV8" data-layout="faithful-v8-approved"><div class="v8-horizon-glow"></div><svg class="v8-road" viewBox="0 0 100 100" preserveAspectRatio="none" aria-hidden="true"><defs><linearGradient id="v8RoadGold" x1="0" y1="1" x2="0" y2="0"><stop offset="0" stop-color="#e7a82c"/><stop offset=".28" stop-color="#ffd66c"/><stop offset=".62" stop-color="#fff0aa"/><stop offset="1" stop-color="#ffd35e"/></linearGradient></defs><path class="halo s1" d="M50 98 C22 91 78 82 52 70"/><path class="halo s2" d="M52 70 C34 63 68 56 50 49"/><path class="halo s3" d="M50 49 C38 43 62 37 50 31"/><path class="halo s4" d="M50 31 C44 26 56 20 50 14"/><path class="halo s5" d="M50 14 C47 11 53 8 50 5"/><path class="core s1" d="M50 98 C22 91 78 82 52 70"/><path class="core s2" d="M52 70 C34 63 68 56 50 49"/><path class="core s3" d="M50 49 C38 43 62 37 50 31"/><path class="core s4" d="M50 31 C44 26 56 20 50 14"/><path class="core s5" d="M50 14 C47 11 53 8 50 5"/></svg></div>';
