...
#rppCrispCopy .collection{margin-top:.8em;font:700 clamp(8px,2.05vw,12px)/1.35 ui-serif,"Times New Roman",serif;letter-spacing:.26em;color:#ead293;animation:rppFineRise .9s .08s cubic-bezier(.16,1,.3,1) both}
#rppCrispCopy .title{margin-top:7.4%;font:500 clamp(36px,9.5vw,66px)/1.00 ui-serif,"Times New Roman","Yu Mincho",serif;letter-spacing:.035em;color:#fff8e8;text-shadow:0 3px 0 rgba(255,255,255,.04),0 11px 42px rgba(0,0,0,.58);animation:rppTitleRise 1.15s .12s cubic-bezier(.16,1,.3,1) both}
#rppCrispCopy .jp{margin-top:5.1%;font:600 clamp(13px,3.25vw,19px)/1.65 ui-serif,"Yu Mincho","Hiragino Mincho ProN",serif;letter-spacing:.08em;color:#f3ead4;animation:rppFineRise 1s .28s cubic-bezier(.16,1,.3,1) both}
#rppCrispCopy .goldRule{width:68%;height:1px;margin:4.2% auto 0;background:linear-gradient(90deg,transparent,#a57321 9%,#f3d77d 50%,#a57321 91%,transparent);box-shadow:0 0 14px rgba(240,200,96,.42);transform-origin:center;animation:rppRuleOpen 1.2s .42s cubic-bezier(.16,1,.3,1) both}
