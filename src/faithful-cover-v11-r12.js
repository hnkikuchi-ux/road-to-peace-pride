...
(()=>{
 ...
 function apply(){
   ...
   if(photoField){const l=photoField.querySelector('label');if(l)l.textContent='写真';let n=photoField.querySelector('.r12-photo-note');if(!n){n=document.createElement('div');n.className='r12-photo-note';n.innerHTML='<b>思い出の写真を1枚添付できます。</b><br>9.12までの歩みや、心に残る一枚をぜひお寄せください。写真は任意です。';photoField.querySelector('#photo')?.insertAdjacentElement('afterend',n)}const old=document.getElementById('photoOptionalNote');if(old)old.style.display='none'}
